...
export function LandingPage() {
	return (
		<StarsBackground className="relative min-h-screen bg-background">
			{/* Navigation */}
			<header className="fixed top-0 left-0 z-100 w-full border-border/50 border-b backdrop-blur supports-backdrop-filter:bg-background/60">
