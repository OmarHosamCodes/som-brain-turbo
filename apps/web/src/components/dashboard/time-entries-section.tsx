import { useTimeEntriesSectionState } from "@som-brain-turbo/hooks";
...
type TimeEntriesSectionState = Omit<
	ReturnType<typeof useTimeEntriesSectionState>,
	"paginatedGroups"
> & {
...
export function TimeEntriesSection() {
	const {
		...
		paginatedGroups,
		totalPages,
	} = useTimeEntriesSectionState() as TimeEntriesSectionState;
