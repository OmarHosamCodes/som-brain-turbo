	...
	return (
		<Card className="border-l-2 border-l-primary/30">
			...
			<CardContent className="space-y-4 pt-4">
				<div className="grid gap-4 xl:grid-cols-[minmax(0,1.35fr)_minmax(0,1fr)_auto]">
					...
					<div className="grid gap-4 sm:grid-cols-[minmax(0,1fr)_auto] xl:grid-cols-[minmax(0,1fr)_auto]">
						<div className="space-y-1.5">
							...
							<select
								...
								value={targetKey}
								onChange={(event) =>
									onTargetKeyChange(event.currentTarget.value)
								}
					...
					<div className="flex flex-wrap items-end gap-2 xl:justify-end">
						...
						{timerIsRunning && activeEntry && (
							<div className="flex min-w-0 items-center gap-2 text-muted-foreground text-xs xl:max-w-56">
